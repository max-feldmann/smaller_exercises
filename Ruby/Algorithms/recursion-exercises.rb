...
def add_numbers(array)
    ...
    array.first + add_numbers(array.drop(1))
end
...
def ice_cream_shop(available_sorts, users_favorite_sort)

    return false if available_sorts.empty?
    return true if available_sorts.first == users_favorite_sort

    ice_cream_shop(available_sorts.drop(1), users_favorite_sort)
end
